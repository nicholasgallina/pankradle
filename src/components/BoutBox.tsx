  ...
  if (!isRevealed) {
    return (
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-white font-bold text-4xl transition-all hover:scale-130 duration-300 hover:rotate-12 cursor-pointer">
          👽
        </div>
      </div>
    );
